...
```javascript
import readFileList from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-file-list@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/fs-read-file-list/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/fs-read-file-list/actions/workflows/test.yml?query=branch:v0.2.3
