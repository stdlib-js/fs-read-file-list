...
```javascript
import readFileList from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-file-list@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-file-list@v0.2.1-deno/mod.js';
```
